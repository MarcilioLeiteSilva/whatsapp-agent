...
# Chave de segurança para falar com a Consigo
INTEGRATION_KEY = os.getenv("CONSIGO_WEBHOOK_KEY") or os.getenv("WHATSAPP_AGENT_KEY") or os.getenv("INTEGRATION_KEY", "consigo-secret-key")
